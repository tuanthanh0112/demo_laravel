            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-pagination-info">
                    ...
                    {{-- <ul class="page-numbers">
                        ...
                        <li><a class="page-number-item" href=" {{ $products->links() }}" >2</a></li>
                        <li><a class="page-number-item" href=" {{ $products->links() }}" >3</a></li>
                        <li><a class="page-number-item next-link" href=" {{ $products->links() }}" >Next</a></li>
                    </ul>
